...
$sql_user = "SELECT funcionario_id FROM usuarios WHERE id = '$idUser'";
$query_user = mysqli_query($con,$sql_user);
$condutor = mysqli_fetch_array($query_user);

$condutor_id = $condutor['funcionario_id'];
			...
			<div class="col-md-offset-1 col-md-10">
                <div class="form-group" align="right">
                    <a href="JavaScript: window.history.back();">
                        <button class="btn btn-theme btn-sm" style='border-radius: 7px;'><strong>Voltar</strong></button></a>
                </div>
