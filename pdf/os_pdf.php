...
$pdf->SetXY($x,35);// SetXY - DEFINE O X (largura) E O Y (altura) NA PÁGINA6
   ...
   $pdf->SetX($x);
   $pdf->SetFont('Arial','', 12);
   $pdf->Cell(40,$l,utf8_decode(""),0,0,'C');
   $pdf->Cell(90,$l,utf8_decode($os['solicitante']),T,0,'C');
   $pdf->Cell(40,$l,utf8_decode(""),0,0,'C');
   ...
   $pdf->SetXY(113, 25+$c);
   $pdf->SetFont('Arial','', 13);
   $pdf->Cell(53,$l,utf8_decode(exibirDataBr($os['data'])),0,0,'L');
   ...
   $pdf->Cell(68,$l,utf8_decode($cliente),0,0,'L');

   $pdf->SetXY($x, 54+$c);
   $pdf->SetFont('Arial','', 10);
   $pdf->MultiCell(120,$l,utf8_decode($os['obs']));
   ...
   $pdf->SetXY($x, 105+$c);
   $pdf->SetFont('Arial','', 12);
   $pdf->Cell(57,$l,utf8_decode("Início: ".substr($os['saida'],0,5)),0,0,'L');
   ...
   $pdf->Cell(57,$l,utf8_decode("____________________________ "),0,0,'L');
    ...
    $pdf->SetXY(100, 128+$c);
   $pdf->SetFont('Arial','', 12);
   $pdf->Cell(57,$l,utf8_decode("Sr(a). ".$os['solicitante']."- Visto"),0,0,'L');
