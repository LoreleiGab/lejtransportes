			...
			<div class="col-md-offset-1 col-md-10">
				<div class="table-responsive list_info">
					<table class='table table-condensed'>
						...
						<?php
							$con = bancoMysqli();
							$sql = "SELECT id, nome, cnh, telefone01 FROM funcionarios ORDER BY nome";
							...
							if($num > 0)
							{
								while($campo = mysqli_fetch_array($query))
								{
									...
									echo "<td class='list_description'>".$campo['cnh']."</td>";
									echo "<td class='list_description'>".$campo['telefone01']."</td>";
									echo "<td class='list_description'>
											<form method='POST' action='?perfil=condutor_edit'>
